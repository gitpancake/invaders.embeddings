"""CLIP encoder wrapper for generating image embeddings on M1 Mac."""
...
class CLIPEncoder:
    ...
    Optimized for M1 Mac using Metal Performance Shaders (mps).
    """
    ...
    def encode_images(self, images: List[Image.Image], batch_size: int = 32) -> np.ndarray:
        ...
        Returns:
            Normalized embedding vectors of shape (n_images, 768)
        """
        all_embeddings = []
